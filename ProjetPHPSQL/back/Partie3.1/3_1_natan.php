    ...
    <div class="container">
        <div class="header">
            ...
            <div class="controls-section">
                <h3>Masquer/Afficher les colonnes :</h3>
                <div class="checkbox-group">
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleEnseignant" checked>
                        <label for="toggleEnseignant">Enseignant</label>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleEtudiant" checked>
                        <label for="toggleEtudiant">Étudiant</label>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleTaches" checked>
                        <label for="toggleTaches">Type d'évaluation</label>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleStatut" checked>
                        <label for="toggleStatut">Statut</label>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleDate" checked>
                        <label for="toggleDate">Date</label>
                    </div>
                    <div class="checkbox-item">
                        <input type="checkbox" id="toggleSalle" checked>
                        <label for="toggleSalle">Salle</label>
                    </div>
                </div>
            </div>

            <div class="table-container">
                <table id="tachesTable" class="display">
        <thead>
            <tr>
                <th>Enseignant</th>
                <th>Étudiant</th>
